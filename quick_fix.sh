#!/bin/bash
echo "🔧 Inarekebisha SmsReceiver kwa Mixx by YAS..."

# Rekebisha SmsReceiver.java
...
echo "✅ SmsReceiver.java imeboreshwa!"
echo "📱 Sasa inasoma SMS za Mixx by YAS tu"
echo "🔗 Server: https://ghosttester.pythonanywhere.com/api/mixx-sms-payment"

# Fanya Git operations
echo "🔨 Inafanya Git push..."
git add .
git commit -m "🔧 Mixx by YAS SMS Receiver"
git push origin main

echo "✅ Ufanisi! Code imesafirishwa kwenye GitHub"
